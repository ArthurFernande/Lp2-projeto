...
public class Show extends BluRay{
	 ...
	 * @param valor eh o valor do blu ray do show.
	 * @param duracao eh a duracao do show.
	 * @param classificacao eh a classificacao, por idade, do show.
	 * @param artista eh o nome do artista.
	 * @param numDeFaixas eh o numero de faixas do show.
	 */
	public Show(String nome, double valor, int duracao,
			 	int classificacao, String artista, int numDeFaixas){

		validaShow(nome, valor, duracao, classificacao, artista, numDeFaixas);
	 ...
	 */
	public boolean validaShow(String nome, double valor, int duracao,
			 				  int classificacao, String artista, int numDeFaixas){
		if (nome == null){
	 ...
	 * @param artista sera o novo nome do artista.
	 */
	 ...
	 * @param numDeFaixas sera o novo numero de faixas
	 */
